...
public class UserUpdateController extends CommonClass implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        //      phoneValidation();
        // TODO: 09/04/2023 Ha ilabin phone validations insha Allah
    }
    ...
    @FXML
    void cancelHandler() {
        closeStage(stage, superAdmin.getParent());
    }
                    ...
                    try {
                        Platform.runLater(() -> {
                            try {
                                ...
                                Platform.runLater(() -> {
                                    Optional<ButtonType> result = informationAlert("User updated successfully 👍🏾")
                                            .showAndWait();
