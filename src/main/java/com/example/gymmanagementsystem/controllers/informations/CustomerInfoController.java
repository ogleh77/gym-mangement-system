...
import com.example.gymmanagementsystem.controllers.main.payments.UpdatePaymentController;
...
public class CustomerInfoController extends CommonClass implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue != null) if (!newValue.isPending() && !newValue.isOnline()) {
    ...
    void deleteHandler() {
        try {
            ...
            boolean done = Alerts.confirmationAlert("Ma hubtaa inaad masaxdo paymentkan.", "Maya", "Haa");
            if (done) {
    ...
    private void pendPayment(Payments payment) throws SQLException {
        ...
        boolean done = Alerts.confirmationAlert("Ma hubtaa inaad hakisto paymentkan oo ay u hadhay \n" + "Wakhtigiisa dhicitaanka " + daysRemain, "Maya", "Haa");

        if (done) {
            PaymentService.pendPayment(payment, currentGym.getPendingDate());
    ...
    private void unPayment(Payments payment) throws SQLException {
        boolean done = Alerts.confirmationAlert("Ma hubtaa inaad dib u furto paymentkan.", "Maya", "Haa");
        if (done) {
