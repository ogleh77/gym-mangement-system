...
public class OutdatedController extends CommonClass implements Initializable {
    ...
    private VBox vBox(int index) {
        ...
        Label label1 = new Label("Fadlan ma jiro macamiil wakhtigu ka dhacay oo leh astamaha aad ku baaadhay.");
    ...
    private String customerQuery() {
        ...
        if (!shift.getValue().equals("All") && activeUser.getRole().equals("admin")) {
