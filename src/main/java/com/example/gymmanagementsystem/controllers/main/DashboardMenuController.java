...
public class DashboardMenuController extends CommonClass implements Initializable {
    ...
    void homeMenuHandler() {
        try {
            FXMLLoader loader = OpenWindow.openFromDashboardWindow("/com/example/gymmanagementsystem/views/main/home.fxml", borderPane, menuHBo);
    ...
    void registrationMenuHandler() {
        try {
            FXMLLoader loader = OpenWindow.openFromDashboardWindow("/com/example/gymmanagementsystem/views/main/registrations.fxml", borderPane, menuHBo);
    ...
    void outDatedMenuHandler() {
        try {
            FXMLLoader loader = OpenWindow.openFromDashboardWindow("/com/example/gymmanagementsystem/views/info/outdated.fxml", borderPane, menuHBo);
    ...
    void reportMenuHandler() {
        try {
            FXMLLoader loader = OpenWindow.openFromDashboardWindow("/com/example/gymmanagementsystem/views/info/dailyReports.fxml", borderPane, menuHBo);
